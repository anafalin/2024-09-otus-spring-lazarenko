...
class JdbcBookRepositoryTest {
    ...
    @DisplayName("должен бросить исключение, что книга по id не найдена")
    @Test
    void save_entityNotFoundException_bookNotExist() {
        var testBook = new Book(100L, "BookTitle_10500", dbAuthors.get(2),
                List.of(dbGenres.get(4), dbGenres.get(5)));

        assertThat(repositoryJdbc.findById(testBook.getId()))
                .isEmpty();

        assertThrows(EntityNotFoundException.class, () -> repositoryJdbc.save(testBook));
